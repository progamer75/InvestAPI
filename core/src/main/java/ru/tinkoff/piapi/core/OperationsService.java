...
public class OperationsService {
  ...
  public Positions getPositionsSync(@Nonnull String accountId) {
    PositionsRequest request = PositionsRequest.newBuilder().setAccountId(accountId).build();
  ...
  public WithdrawLimits getWithdrawLimitsSync(@Nonnull String accountId) {
    WithdrawLimitsRequest request = WithdrawLimitsRequest.newBuilder().setAccountId(accountId).build();
  ...
  public GetDividendsForeignIssuerReportResponse getDividendsForeignIssuerSync(@Nonnull String taskId, int page) {
    ...
    GetDividendsForeignIssuerRequest request = GetDividendsForeignIssuerRequest.newBuilder()
  ...
  public BrokerReportResponse getBrokerReportSync(@Nonnull String accountId,
    ...
    BrokerReportRequest request = BrokerReportRequest.newBuilder()

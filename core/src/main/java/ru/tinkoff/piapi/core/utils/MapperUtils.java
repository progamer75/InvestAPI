...
public class MapperUtils {
  ...
  public static BigDecimal futuresPrice(Quotation pricePoints, GetFuturesMarginResponse futuresMarginResponse) {
    BigDecimal minPriceIncrement = quotationToBigDecimal(futuresMarginResponse.getMinPriceIncrement());
    BigDecimal minPriceIncrementAmount = quotationToBigDecimal(futuresMarginResponse.getMinPriceIncrementAmount());
